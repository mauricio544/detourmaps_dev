...
// Scroll to  --------
	...
	$('.to-top, .logo').click(function() {$('html').scrollTo('.simple-page-head ,#topSlide',1500,{'axis':'y'});hidemenu();});
	$('.start').click(function(event) {event.preventDefault(); $('html').scrollTo('#about',1500,{'axis':'y'});});
...
$('.show-panel').click(function(){		
	$('.panelapps').slideToggle(500);			
});

$('.andjs').click(function(){		
