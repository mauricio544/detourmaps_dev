...
def all_business_json(request):
    ...
    business_objects = Business.objects.all().prefetch_related('community').order_by('local_deals', 'ten_visits', 'refer_friends')
    lista_business = []
    return_community = lambda biz_community: biz_community or ''
    return_category = lambda biz_category: biz_category or ''
    comm_id = ""
...
def community_business_json(request):
    ...
    business_objects = Business.objects.filter(community=community_object).prefetch_related('community').order_by('local_deals', 'ten_visits', 'refer_friends')
    lista_business = []
    return_community = lambda biz_community: biz_community or ''
    return_category = lambda biz_category: biz_category or ''
    comm_id = ""
...
@csrf_exempt
def category_business_json(request):
    user_session = False
    if request.session.get("user"): user_session = True
    community_object = Community.objects.filter(active=True).order_by('name')
    lista_communities = []
    ...
    for i in categories_object:
        ...
        lista_categories.append(dict_cat)#categories
    category_object = Category.objects.get(pk=request.GET['id'])
    business_objects = Business.objects.filter(category=category_object).order_by('local_deals', 'ten_visits', 'refer_friends')
    lista_business = []
    return_community = lambda biz_community: biz_community or ''
    return_category = lambda biz_category: biz_category or ''
    comm_id = ""
...
@csrf_exempt
def deals_business_json(request):
    user_session = False
    if request.session.get("user"): user_session = True
    community_object = Community.objects.filter(active=True).order_by('name')
    lista_communities = []
    ...
    for i in business_objects:
        if i.cuponbusiness_set.filter(active=1).count() > 0:
            ...
            lista_business.append(dict_business)
    for i in business_objects.filter(Q(local_deals='T') | Q(local_deals="Q") | Q(local_deals='F')):
        ten_off = False
        smart_buys = False
        monthly_promo = False
        if i.community:
        ...
        lista_business.append(dict_business)
    for i in business_objects.filter(ten_visits=1):
        ten_off = False
        smart_buys = False
        monthly_promo = False
        if i.community:
        ...
        lista_business.append(dict_business)
    for i in business_objects.filter(refer_friends=1):
        ten_off = False
        smart_buys = False
        monthly_promo = False
        if i.community:
